...
//        return r.query(sql, new MapHandler());
    ...
    //用户浏览信息查询
    public void insert1(Goods g,String username,long dwelltime,String goodsname) throws SQLException {
        QueryRunner r = new QueryRunner(DataSourceUtils.getDataSource());
        String sql = "insert into userbrowsing(username,dwelltime,goodsid,goodsname) values(?,?,?,?)";
        r.update(sql,username,dwelltime,g.getId(),goodsname);
    }
